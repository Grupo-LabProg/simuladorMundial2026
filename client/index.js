...
async function cargarEquipos() {
  try {
    console.log("Entrando en cargarEquipos()")
    ...
    console.log("Lo que trae cargarEquipos(): " + JSON.stringify(equipos));
    console.log("Lo que trae cargarEquipos(): " + equipos);
    let confederaciones = equipos.map(elemento => Object.entries(elemento));
    console.log("Confederaciones es: " + confederaciones);
    AFC = JSON.stringify(equipos.AFC);
    console.log("AFC es: " + AFC);
    CAF = equipos.CAF;
    CONCACAF = equipos.CONCACAF;
    UEFA = equipos.UEFA;
    CONMEBOL = equipos.CONMEBOL;
    OFC = equipos.OFC;
    console.log("Saliendo de cargarEquipos()")
  } catch (error) {
